 ...
 *
 * `switch` is when the playful storybook track hands over to the stormy one,
 * in seconds. The two are crossfaded, and the bed is ducked automatically
 * wherever the narrator is speaking.
 */
...
const CROSSFADE = 4;
const BED_LEVEL = 0.16;   // music under narration
...
const playful = path.join(root, 'public/music/storybook.wav');
const stormy = path.join(root, 'public/music/storm-to-triumph.wav');
